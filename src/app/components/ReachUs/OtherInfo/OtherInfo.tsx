    ...
    <section className='flex flex-col justify-start gap-10'>
      <section className='flex flex-col justify-center text-center lg:text-left'>
        ...
        <section className='flex flex-wrap justify-center lg:justify-start gap-2'>
          <a href='https://wa.me/11981063924' target='_blank' className="btn-p">
          ...
          <a href='https://www.instagram.com/imperialconsorcio/?hl=en' target='_blank' className="btn-p">
          ...
          <a href='https://www.facebook.com/imperialconsorcio/' target='_blank' className="btn-p">
      ...
      <section className='text-center lg:text-left'>
        ...
        <p className='font-medium'>De segunda a sexta, das 9h às 18h, exceto feriados.</p>
      </section>

      <section className='text-center lg:text-left'>
        <h4 className="text-white text-2xl font-bold mb-2">Endereço</h4>
        <p className='font-medium'>Rua Lourenço Marques, 315 - Vila Olímpia - São Paulo - SP.</p>
      </section>

      <section className='text-center lg:text-left'>
        <h4 className="text-white text-2xl font-bold mb-2">Serviços por telefone</h4>
        <p className='font-medium'>0800 724 4770 / 51 3358 4770</p>
      </section>
    </section>
  )
}
