...
const Footer = () => {
  return (
    <>
      <footer className="footer bg-primary text-white p-10 mt-44">
        <nav id='contact'>
          <header className="font-bold uppercase text-white">Contato</header>
          <Link href='https://wa.me/11981063924'>WhatsApp (22) 22222-2222</Link>
          <Link href='/mailto:imperial@gmail.com'>Email: imperial@gmail.com</Link>
          <Link href='/instagram'>Instagram</Link>
          <Link href='/#advantages'>Telefone: (11) 11111-1111</Link>
        </nav>
        <nav>
          <header className="font-bold uppercase text-white">Empresa</header>
          <Link href='/'>Home</Link>
      ...
      <footer className="footer px-10 bg-primary text-white py-4 border-t border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>Imperial Consórcios Ltd. <br />Providing reliable tech since 1992</p>
        </aside>
